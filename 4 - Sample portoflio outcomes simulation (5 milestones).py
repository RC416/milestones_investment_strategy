...
outcomes_sample = [[generate_outcome(n_milestones_sample[x], stage_prob) for x in range(0,5)] for x in range(0,n_portfolios)]
...
for outcome in outcomes_sample:
    ...
    for n in range(0,5):
        ...
        # note syntax for outcomes_sample[outcome #][deal #]
